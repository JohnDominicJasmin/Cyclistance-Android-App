...
import com.myapp.cyclistance.feature_mapping.data.data_source.network.dto.rescue_transaction.CancellationDto
import com.myapp.cyclistance.feature_mapping.data.data_source.network.dto.rescue_transaction.CancellationReasonDto
...
import com.myapp.cyclistance.feature_mapping.data.data_source.network.dto.rescue_transaction.RouteDto
import com.myapp.cyclistance.feature_mapping.data.data_source.network.dto.rescue_transaction.StatusDto
...
object RescueTransactionMapper {
    fun RescueTransactionItemDto.toRescueTransaction(): RescueTransactionItem {
        return RescueTransactionItem(
            ...
            endingMillis = this.endingMillis
        )
    }
