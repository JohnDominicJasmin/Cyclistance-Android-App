...
import com.myapp.cyclistance.feature_mapping.presentation.mapping_main_screen.components.dialog.incident_description.ChooseMarkerSection
import com.myapp.cyclistance.feature_mapping.presentation.mapping_main_screen.components.dialog.incident_description.HazardousIncidentIndicator
import com.myapp.cyclistance.feature_mapping.presentation.mapping_main_screen.components.dialog.incident_description.incidentMarkers
    ...
    if (isDialogOpen) {
        ...
        Dialog(
            ...
            Card(
                modifier = modifier
                    .fillMaxWidth(0.93f)
                    .shadow(shape = RoundedCornerShape(size = 12.dp), elevation = 8.dp),
                    ...
                    Column(
                        ...
                        if (uiState.incidentImageUri != null) {
                            ...
                            AddIncidentImage(
                                ...
                                errorMessage = uiState.incidentImageErrorMessage)
                        }
...
@Preview
@Composable
fun PreviewDialogReportIncidentDark() {
        ...
        CyclistanceTheme(darkTheme = isDarkTheme) {
            Box(
                ...
                ReportIncidentDialog(
                    ...
                    addIncidentImage = {},
                    viewImage = {},
                    uiState = MappingUiState(incidentImageUri = "asd"), onDismissRequest = {},
                )
            }
        }
    }
...
@Preview
@Composable
fun PreviewDarkReportIncidentLight() {
        ...
        CyclistanceTheme(darkTheme = isDarkTheme) {
            Box(
                ...
                ReportIncidentDialog(
                    ...
                    addIncidentImage = {},
                    viewImage = {},
                    uiState = MappingUiState(), onDismissRequest = {})
            }
        }
    }
}
