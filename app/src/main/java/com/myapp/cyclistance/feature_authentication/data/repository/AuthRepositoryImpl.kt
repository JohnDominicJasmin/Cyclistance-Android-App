package com.myapp.cyclistance.feature_authentication.data.repository
...
import com.myapp.cyclistance.core.utils.constants.AuthConstants.USER_ACCOUNT_DISABLED
import com.myapp.cyclistance.core.utils.constants.AuthConstants.USER_NOT_FOUND
import com.myapp.cyclistance.core.utils.constants.UtilConstants.USER_COLLECTION
import com.myapp.cyclistance.feature_authentication.data.mapper.AuthResultMapper.toAuthenticationResult
            ...
            suspendCancellableCoroutine { continuation ->
                ...
                auth.signInWithCredential(signInCredential)
                    .addOnCompleteListener { task ->
                        ...
                        task.exception?.let { exception ->
                            Timber.v("Sign in with credential completed ${exception.message}")
                        ...
                        Timber.v("Sign in with credential failed ${it.message}")
                    }.addOnCanceledListener {
                        Timber.v("Sign in with credential cancelled")
                    }
            }
        }
    }
